...
const SolutionDetail = () => {
    ...
    return (
      <div className="flex min-h-screen items-center justify-center">
        <div className="text-center">
          <h1 className="text-3xl font-semibold text-white">Solution Not Found</h1>
          <p className="mt-4 text-neutral-400">The solution you're looking for doesn't exist.</p>
          <Link
            to="/solutions"
  ...
  // Find related solutions (same category, excluding current)
  // If no same category, show other solutions
  const relatedSolutions = solutions
    .filter((s) => s.id !== solution.id)
    .sort((a, b) => {
      // Prioritize same category
      if (a.category === solution.category && b.category !== solution.category) return -1
      if (a.category !== solution.category && b.category === solution.category) return 1
      return 0
    })
    .slice(0, 3)
        ...
        <div className="mx-auto max-w-4xl px-6">
          ...
          >
            ...
            <div className="mt-8 flex items-center gap-3">
              ...
              <p className="text-xs font-semibold uppercase tracking-[0.3em] text-neutral-400">Solution</p>
            </div>
            <h1 className="mt-6 text-4xl font-semibold text-white sm:text-5xl lg:text-6xl">{solution.title}</h1>
            <p className="mt-4 text-xl text-primary-300">{solution.subtitle}</p>
            <p className="mt-6 text-base leading-relaxed text-neutral-300">{solution.description}</p>
          </Motion.div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl px-6">
          ...
          >
            ...
            <p className="mt-4 text-neutral-300">
              Let's discuss how {solution.title} can help solve your business challenges.
            </p>
            <Link
              to="/contact"
        ...
        <section className="border-t border-neutral-400/10 py-20">
          <div className="mx-auto max-w-7xl px-6">
            <div className="mb-12 text-center">
              <p className="text-xs font-semibold uppercase tracking-[0.4em] text-primary-400">Related Solutions</p>
              <h2 className="mt-4 text-3xl font-semibold text-white">Explore More Solutions</h2>
            </div>
            <div className="grid gap-8 md:grid-cols-3">
              {relatedSolutions.map((related, index) => (
                ...
                >
                  <Link to={`/solutions/${related.slug}`}>
                    {related.image && (
