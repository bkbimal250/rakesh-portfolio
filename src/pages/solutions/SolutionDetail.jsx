        ...
        <div className="mx-auto max-w-4xl px-6">
          ...
          >
            ...
            <div className="mt-8 flex items-center gap-3">
              ...
              <p className={`text-xs font-semibold uppercase tracking-[0.3em] ${metaTextClass}`}>Solution</p>
            </div>
            <h1 className={`mt-6 text-4xl font-semibold sm:text-5xl lg:text-6xl ${headingClass}`}>{solution.title}</h1>
            <p className={`mt-4 text-xl ${subtitleClass}`}>{solution.subtitle}</p>
            <p className={`mt-6 text-base leading-relaxed ${bodyTextClass}`}>{solution.description}</p>
          </Motion.div>
        </div>
      </section>
        ...
        <section className="border-t border-neutral-400/10 py-20">
          <div className="mx-auto max-w-7xl px-6">
            <div className="mb-12 text-center">
              ...
              <h2 className={`mt-4 text-3xl font-semibold ${headingClass}`}>Explore More Solutions</h2>
            </div>
